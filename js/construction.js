...
/* ═══════════════════════════════════════════════
   MATERIALS ENGINE
   ═══════════════════════════════════════════════ */
function matDate(n) { const d=new Date(); d.setDate(d.getDate()+n); return d.toISOString().slice(0,10); }

const DEMO_MATERIALS = [
  { id:'m1', item:'HVAC Compressor Unit - 5-Ton Carrier', supplier:'AirTech Commercial HVAC', po:'PO-2026-0047', qty:2, unitCost:'$2,400', totalCost:'$4,800', status:'delivered', expectedDelivery:matDate(-2), property:'628 State St (Kress Building)', notes:'Rooftop unit replacement for ticket t3. Crane lift scheduled. Units on-site.' },
  { id:'m2', item:'Commercial LED Panel Fixtures (4x2 ft)', supplier:'Tri-Cities Electrical Supply', po:'PO-2026-0051', qty:24, unitCost:'$85', totalCost:'$2,040', status:'installed', expectedDelivery:matDate(-9), property:'628 State St (Kress Building)', notes:'Suite 201 lighting for panel upgrade (ticket t9). All panels installed by Marcus Bell.' },
  { id:'m3', item:'Fire-Rated Drywall Sheets (5/8 in Type X)', supplier:'Lowes Commercial', po:'PO-2026-0055', qty:80, unitCost:'$18', totalCost:'$1,440', status:'delivered', expectedDelivery:matDate(-5), property:'City Centre (601 State St)', notes:'Suite 3B buildout partition walls (ticket t1). Tyler Brooks picked up from Lowes.' },
  { id:'m4', item:'RTU Ductwork Transition Kit', supplier:'AirTech Commercial HVAC', po:'PO-2026-0058', qty:1, unitCost:'$1,200', totalCost:'$1,200', status:'shipped', expectedDelivery:matDate(3), property:'628 State St (Kress Building)', notes:'Custom fab for rooftop HVAC connection (ticket t3). In transit from Nashville.' },
  { id:'m5', item:'Vinyl Plank Flooring - Luxury Grade (Weathered Oak)', supplier:'Shaw Commercial Flooring', po:'PO-2026-0061', qty:1200, unitCost:'$3.50/sqft', totalCost:'$4,200', status:'ordered', expectedDelivery:matDate(9), property:'Jamestown @ Shelby', notes:'Bldg B common area refresh (ticket t8). Color: Weathered Oak. Noah + Ryan installing.' },
  { id:'m6', item:'ADA Compliant Exterior Signage Package', supplier:'Bristol Sign Co', po:'PO-2026-0063', qty:3, unitCost:'$650', totalCost:'$1,950', status:'ordered', expectedDelivery:matDate(14), property:'City Centre (601 State St)', notes:'Suite directory + wayfinding (ticket t6). Delayed at fabricator.' },
  { id:'m7', item:'Bathroom Fixture Set (Vanity + Toilet + Shower)', supplier:'Ferguson Enterprises', po:'PO-2026-0068', qty:1, unitCost:'$2,800', totalCost:'$2,800', status:'delivered', expectedDelivery:matDate(-3), property:'Bradley St Residential', notes:'Unit 2 bathroom overhaul (ticket t7). Allen selected fixtures. On-site ready for install.' },
  { id:'m8', item:'Epoxy Floor Coating (2-Part Commercial)', supplier:'Sherwin-Williams Commercial', po:'PO-2026-0072', qty:10, unitCost:'$95/gal', totalCost:'$950', status:'delivered', expectedDelivery:matDate(-1), property:'Center Point Corridor', notes:'Unit 4 tenant turnover (ticket t10). Medium gray. Chris Painter applying after wall paint cures.' }
];
...
const DEMO_CREW = [
  ...
  { id:'c7', name:'Sam Patterson', company:'Appalachian Paving & Seal', type:'outside', role:'Foreman', trade:'general', phone:'(423) 555-0244', email:'sam@appaving.com', rating:4, notes:'Asphalt, concrete, striping, curb repair. Handles all parking lot work.', status:'active' },
